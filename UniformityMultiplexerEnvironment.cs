...
namespace XCS
{
	class UniformityMultiplexerEnvironment : Environment
	{
		...
		// Environment作成
		public UniformityMultiplexerEnvironment( int Length, double NoiseWidth )
		{
			this.Length = Length;
			this.Number = 2;    // 2進数
        ...
        public override double GetReward()
		{
			...
			//( this.Action == act )
			//{
				return Configuration.Rho + this.NoiseWidth * ( 1.0 - 2 * Configuration.MT.NextDouble() );
			//}
			//else
			//{
				//return 0.0 + this.NoiseWidth * ( 1.0 - 2 * Configuration.MT.NextDouble() );
			//}
		}
